...
-- Subscriptions table: users can view, update, and delete their own subscriptions
...
-- Cancellations table: users can insert, view, and update their own cancellations
